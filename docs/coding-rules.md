...
## MVP Scope Guardrail (Issue #1)
For Issue #1 and other MVP-scoped work:
- Deliver only what is explicitly required for MVP acceptance.
- Avoid non-essential refactors, abstractions, or platformization.
- Defer optimizations and optional enhancements unless they unblock MVP acceptance criteria.
