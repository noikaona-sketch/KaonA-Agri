...
## MVP Scope Note (Issue #1)
For MVP delivery, implement only role/permission behavior required by Issue #1 acceptance criteria. Advanced policy variants can be phased post-MVP.
