...
const DEPT_NAV: Record<string, string[]> = {
  super_admin: ['แดชบอร์ด','สมาชิก','เกษตร','เมล็ด','ขาย','คลัง','รถเกี่ยว','รายงาน','คะแนนบริการ','เครดิต','บริการ','เจ้าหน้าที่','สื่อสาร','System Map'],
  admin:       ['แดชบอร์ด','สมาชิก','เกษตร','เมล็ด','ขาย','คลัง','รถเกี่ยว','คะแนนบริการ','เครดิต','บริการ','สื่อสาร','System Map'],
