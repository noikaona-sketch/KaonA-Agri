...
const DEPT_NAV: Record<string, string[]> = {
  super_admin: ['แดชบอร์ด','คิวอนุมัติ','สมาชิกทั้งหมด','จัดการ Role','จัดกลุ่ม','สร้าง PIN','ภาพรวมฟาร์ม','แปลงเกษตร','รอบเพาะปลูก','งดเผา','งานตรวจ','POS ขาย/จอง','นัดขายผลผลิต','นัดรถเกี่ยว','คำสั่งซื้อ','สินค้า','สต๊อก','เมล็ดพันธุ์','การจองบริการ','เจ้าหน้าที่'],
  admin:       ['แดชบอร์ด','คิวอนุมัติ','สมาชิกทั้งหมด','จัดการ Role','จัดกลุ่ม','สร้าง PIN','ภาพรวมฟาร์ม','แปลงเกษตร','รอบเพาะปลูก','งดเผา','งานตรวจ','POS ขาย/จอง','นัดขายผลผลิต','นัดรถเกี่ยว','คำสั่งซื้อ','สินค้า','สต๊อก','เมล็ดพันธุ์','การจองบริการ','เจ้าหน้าที่'],
