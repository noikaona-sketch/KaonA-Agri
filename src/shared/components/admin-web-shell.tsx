...
const DEPT_NAV: Record<string, string[]> = {
  super_admin: ['แดชบอร์ด','สมาชิก','เกษตร','เมล็ด','ขาย','รถเกี่ยว','คะแนนบริการ','เครดิต','บริการ','เจ้าหน้าที่'],
  admin:       ['แดชบอร์ด','สมาชิก','เกษตร','เมล็ด','ขาย','รถเกี่ยว','คะแนนบริการ','เครดิต','บริการ','เจ้าหน้าที่'],
