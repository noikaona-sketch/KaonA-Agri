...
const DEPT_NAV: Record<string, string[]> = {
  super_admin: ['แดชบอร์ด','สมาชิก','เกษตร','เมล็ด','ขาย','คลัง','Product Master','รถเกี่ยว','คะแนนบริการ','เครดิต','บริการ','เจ้าหน้าที่'],
  admin:       ['แดชบอร์ด','สมาชิก','เกษตร','เมล็ด','ขาย','คลัง','Product Master','รถเกี่ยว','คะแนนบริการ','เครดิต','บริการ','เจ้าหน้าที่'],
  field:       ['แดชบอร์ด','สมาชิก','เกษตร','รถเกี่ยว','คะแนนบริการ','บริการ'],
  sales:       ['แดชบอร์ด','สมาชิก','เมล็ด','ขาย','คลัง','Product Master','เครดิต'],
  accounting:  ['แดชบอร์ด','ขาย','คลัง','Product Master','เครดิต'],
  finance:     ['แดชบอร์ด','ขาย','คลัง','Product Master','เครดิต'],
  stock:       ['แดชบอร์ด','เมล็ด','ขาย','คลัง','Product Master'],
};
