...
const DEPT_NAV: Record<string, string[]> = {
  super_admin: ['แดชบอร์ด','คิวอนุมัติ','สมาชิกทั้งหมด','จัดการ Role','จัดกลุ่ม','สร้าง PIN','ภาพรวมฟาร์ม','แปลงเกษตร','รอบเพาะปลูก','งดเผา','งานตรวจ','POS ขาย/จอง','คำสั่งซื้อ','สินค้า','สต๊อก','เมล็ดพันธุ์','การจองบริการ','เจ้าหน้าที่'],
  admin:       ['แดชบอร์ด','คิวอนุมัติ','สมาชิกทั้งหมด','จัดการ Role','จัดกลุ่ม','สร้าง PIN','ภาพรวมฟาร์ม','แปลงเกษตร','รอบเพาะปลูก','งดเผา','งานตรวจ','POS ขาย/จอง','คำสั่งซื้อ','สินค้า','สต๊อก','เมล็ดพันธุ์','การจองบริการ','เจ้าหน้าที่'],
  field:       ['แดชบอร์ด','คิวอนุมัติ','สมาชิกทั้งหมด','จัดกลุ่ม','สร้าง PIN','ภาพรวมฟาร์ม','แปลงเกษตร','รอบเพาะปลูก','งดเผา','งานตรวจ','การจองบริการ'],
  sales:       ['แดชบอร์ด','สมาชิกทั้งหมด','แปลงเกษตร','รอบเพาะปลูก','POS ขาย/จอง','คำสั่งซื้อ','สินค้า','สต๊อก','เมล็ดพันธุ์','การจองบริการ'],
