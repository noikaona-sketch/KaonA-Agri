...
const ALL_NAV: NavItem[] = [
  ...
  { label: 'ประกาศ', href: '/admin/campaigns', icon: '📢' },
];

const DEPT_NAV: Record<string, string[]> = {
  super_admin: ['แดชบอร์ด','สมาชิก','เกษตร','เมล็ด','ขาย','คลัง','รถเกี่ยว','คะแนนบริการ','เครดิต','บริการ','เจ้าหน้าที่','ประกาศ'],
  admin:       ['แดชบอร์ด','สมาชิก','เกษตร','เมล็ด','ขาย','คลัง','รถเกี่ยว','คะแนนบริการ','เครดิต','บริการ','ประกาศ'],
  field:       ['แดชบอร์ด','สมาชิก','เกษตร','รถเกี่ยว','คะแนนบริการ','บริการ','ประกาศ'],
  sales:       ['แดชบอร์ด','สมาชิก','เมล็ด','ขาย','คลัง','เครดิต','ประกาศ'],
  accounting:  ['แดชบอร์ด','ขาย','คลัง','เครดิต','ประกาศ'],
  finance:     ['แดชบอร์ด','ขาย','คลัง','เครดิต','ประกาศ'],
  stock:       ['แดชบอร์ด','เมล็ด','ขาย','คลัง','ประกาศ'],
};
