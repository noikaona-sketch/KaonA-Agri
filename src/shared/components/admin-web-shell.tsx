...
const ALL_NAV: NavItem[] = [
  ...
  { label: 'ทีม',        href: '/admin/teams',  icon: '👥' },
  { label: 'สื่อสาร',   href: '/admin/comms',      icon: '📡' },
  { label: 'System Map', href: '/admin/system-map', icon: '🗺️' },
  { label: 'UAT',        href: '/admin/uat',        icon: '🧪' },
];

const DEPT_NAV: Record<string, string[]> = {
  super_admin: ['แดชบอร์ด','สมาชิก','เกษตร','เมล็ด','ขาย','คลัง','รถเกี่ยว','รายงาน','คะแนนบริการ','เครดิต','บริการ','เจ้าหน้าที่','ทีม','สื่อสาร','System Map','UAT'],
  admin:       ['แดชบอร์ด','สมาชิก','เกษตร','เมล็ด','ขาย','คลัง','รถเกี่ยว','รายงาน','คะแนนบริการ','เครดิต','บริการ','เจ้าหน้าที่','ทีม','สื่อสาร','System Map','UAT'],
  field:       ['แดชบอร์ด','สมาชิก','เกษตร','รถเกี่ยว','คะแนนบริการ','บริการ','สื่อสาร'],
  sales:       ['แดชบอร์ด','สมาชิก','เมล็ด','ขาย','คลัง','เครดิต','สื่อสาร'],
  accounting:  ['แดชบอร์ด','ขาย','คลัง','เครดิต','สื่อสาร'],
  finance:     ['แดชบอร์ด','ขาย','คลัง','เครดิต','สื่อสาร'],
  stock:       ['แดชบอร์ด','เมล็ด','ขาย','คลัง','สื่อสาร'],
};
