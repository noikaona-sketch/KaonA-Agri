...
-- 1. products.seed_variety_id FK
-- 2. products.product_code unique
-- 3. One active seed product per variety (unique partial index)
-- 4. seed_reservations.seed_variety_id snapshot
-- 5. Immutable product_id on seed_reservations after insert
...
-- human-readable code unique per non-deleted product
...
-- one active seed product per variety
...
-- ── seed_reservations ─────────────────────────────────────────────────
-- snapshot: variety FK at booking time (read-only after insert)
